...
public class ModPlacedFeatures {
    ...
    public static final RegistryObject<PlacedFeature> CHLOROPHYTE_ORE_PLACED = PLACED_FEATURES.register("chlorophyte_ore_placed",
            () -> new PlacedFeature(ModConfiguredFeatures.CHLOROPHYTE_ORE.getHolder().get(),
